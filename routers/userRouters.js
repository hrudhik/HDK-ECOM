...
router.get('/google/callback',
  passport.authenticate('google', { failureRedirect: '/signup?errorr=Your account is blocked. Please contact support.', failureMessage: true }),
  (req, res) => {
    ...
    if (req.user.isBlocked === false) {
      ...
      res.redirect('/signup?errorr=Your account is blocked. Please contact support.');
    }
  }
);
